...
# These are created once at module load and used as fallback when DB is unreachable.
SEED_USERS = {
    "admin@devhive.ai": {
...
# Runtime-registered users (via /register) — in-memory fallback
_registered_users = {}
...
async def register(request: RegisterRequest):
    # Check duplicates in seed users and runtime cache
